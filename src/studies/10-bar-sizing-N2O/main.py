...
OxidiserDensity__kg_per_m3 = 2.85
OxidiserViscosity__Pa_s=0.0000147

InputParameters = RafikiInputParameters(	fuel="Isopropanol",
											oxidiser="N2O",
											fuel_concentration=99,
											oxidiser_concentration=100,
											oxidiser_fuel_mass_ratio=3.2,
											peak_thrust__N=2000,
											chamber_pressure__bar=10,
											ambient_pressure__bar=1	)

FineTunedRafikiOutputParameters = RafikiOutputParameters(	epsilon=2.147,
															gamma=1.238,
															Isp__s=196.468,
															Tc__K=2665.174,
															M__kg_per_kmol=22.234,
															Pr_exit=0.453,
															mu_exit__Pa_s=7.073e-05,
															k_exit__W_per_m_K=0.278,
															R__J_per_kg_K=373.926,
															m_dot__kg_per_s=1.038,
															mf_dot__kg_per_s=0.247,
															mo_dot__kg_per_s=0.791,
