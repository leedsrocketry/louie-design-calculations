...
class Rafiki:
    def __init__(self, rootdir, cfg, test_run=False, param_study_mode=False):
    ...
    def data_to_CSV(self):
        ...
        data_path = self.rootdir+"/data/"
        if not os.path.exists(data_path):
            os.makedirs(data_path)
            
        # save data to csv
        csv_name = self.rootdir+"/data/"+self.project_name+"_"+datetime.now().strftime('%b%d_%H-%M-%S') + ".csv"
        csv_file = csv.writer(open(csv_name, 'w'))
